...
export default function JpQuestions() {
  ...
  const buttons = (
    <>
      ...
      <IonButton onClick={changeToSubstantivisator1}>
        substantivisator1
      </IonButton>
      ...
      <IonButton onClick={changeToPlacementAndCounting}>
        placement and counting
      </IonButton>
      <IonButton onClick={changeToAIsButBIsnt}>A is but B isnt</IonButton>
      <IonButton onClick={changeToACanEtcButBCantEtc}>
        A can but B cant
      </IonButton>
      ...
      <IonButton onClick={changeToIDidntKnowSthIsAdj}>
        didnt know sth is x
      </IonButton>
      <IonButton onClick={changeToIDidntKnowYouDontLike}>
        didnt know you dont like
      </IonButton>
      ...
      <IonButton onClick={changeToUnfortunatelyIDontSpeak}>
        unfortunately I dont speak
      </IonButton>
  ...
  return (
    <>
      <IonCard>
        ...
        <IonCardContent>{buttons}</IonCardContent>
      </IonCard>
