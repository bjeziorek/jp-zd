...
export function afterTime(theme:Theme):DataType{
    ...
    return{
        ...
        meaning:who.pl.M+' po tym, gdy (po) '+verb1.pl.os3+'ł(a) do '+place1.pl.D+', '+verb2.pl.os3+'ł(a) '+adj.pl+' '+what.pl.B+' w '+place2.pl.Msc
    }
}