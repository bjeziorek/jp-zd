...
export const nouns: Noun = {
    ...
    animals: [
        ...
        { jp: 'kamoshika', pl: caseDeclination('antylopa'), counter: 'tou', plGender: 'ż', isAlive: true, isHuman: false, tags: ['animals'] },// ['sarna', 'sarny'] },
        { jp: 'suigyuu', pl: caseDeclination('bawół'), counter: 'tou', plGender: 'm', isAlive: true, isHuman: false, tags: ['animals'] },// ['sarna', 'sarny'] },
        { jp: 'kiji', pl: caseDeclination('bażant'), counter: 'wa', plGender: 'm', isAlive: true, isHuman: false, tags: ['animals'] },// ['sarna', 'sarny'] },
        { jp: 'kounotori', pl: caseDeclination('bocian'), counter: 'wa', plGender: 'm', isAlive: true, isHuman: false, tags: ['animals'] },// ['sarna', 'sarny'] },
        { jp: 'sai', pl: caseDeclination('nosorożec'), counter: 'tou', plGender: 'm', isAlive: true, isHuman: false, tags: ['animals'] },// ['sarna', 'sarny'] },
        { jp: 'roba', pl: caseDeclination('osioł'), counter: 'tou', plGender: 'm', isAlive: true, isHuman: false, tags: ['animals'] },// ['sarna', 'sarny'] },
        { jp: 'kujaku', pl: caseDeclination('paw'), counter: 'wa', plGender: 'm', isAlive: true, isHuman: false, tags: ['animals'] },// ['sarna', 'sarny'] },
        { jp: 'oumu', pl: caseDeclination('papuga'), counter: 'wa', plGender: 'ż', isAlive: true, isHuman: false, tags: ['animals'] },// ['sarna', 'sarny'] },
        { jp: 'tora', pl: caseDeclination('tygrys'), counter: 'tou', plGender: 'm', isAlive: true, isHuman: false, tags: ['animals'] },// ['sarna', 'sarny'] },
        { jp: 'inoshishi', pl: caseDeclination('dzik'), counter: 'tou', plGender: 'm', isAlive: true, isHuman: false, tags: ['animals'] },//  ['dzik', 'dzika'] },
        { jp: 'hebi', pl: caseDeclination('wąż'), counter: 'hiki', plGender: 'm', isAlive: true, isHuman: false, tags: ['animals'] },// ['mucha', 'muchy'] },
        { jp: 'shimauma', pl: caseDeclination('zebra'), counter: 'tou', plGender: 'ż', isAlive: true, isHuman: false, tags: ['animals'] },// ['mucha', 'muchy'] },
        { jp: 'tsuru', pl: caseDeclination('żuraw'), counter: 'wa', plGender: 'm', isAlive: true, isHuman: false, tags: ['animals'] },// ['mucha', 'muchy'] },
    ...
    professions: [
        ...
        { jp: "shufu", pl: caseDeclination('gospodyni domowa'), counter: 'nin', plGender: 'm', isAlive: true, isHuman: true, tags: ['professions'] },
        { jp: "noufu", pl: caseDeclination('rolnik'), counter: 'nin', plGender: 'm', isAlive: true, isHuman: true, tags: ['professions'] },
        { jp: "ryoushi", pl: caseDeclination('wędkarz'), counter: 'nin', plGender: 'm', isAlive: true, isHuman: true, tags: ['professions'] },
        { jp: "kenchikugyousha", pl: caseDeclination('budowniczy'), counter: 'nin', plGender: 'm', isAlive: true, isHuman: true, tags: ['professions'] },
        { jp: "kensetsugenba", pl: caseDeclination('stewardesa'), counter: 'nin', plGender: 'm', isAlive: true, isHuman: true, tags: ['professions'] },
        { jp: "saibankan", pl: caseDeclination('sędzia'), counter: 'nin', plGender: 'm', isAlive: true, isHuman: true, tags: ['professions'] },
        { jp: "mushoku", pl: caseDeclination('bezrobotny'), counter: 'nin', plGender: 'm', isAlive: true, isHuman: true, tags: ['professions'] },
        { jp: "shachou", pl: caseDeclination('dyrektor'), counter: 'nin', plGender: 'm', isAlive: true, isHuman: true, tags: ['professions'] },
        { jp: "keieisha", pl: caseDeclination('przedsiębiorca'), counter: 'nin', plGender: 'm', isAlive: true, isHuman: true, tags: ['professions'] },
        { jp: "koumuin", pl: caseDeclination('urzędnik'), counter: 'nin', plGender: 'm', isAlive: true, isHuman: true, tags: ['professions'] },
        { jp: "bengoshi", pl: caseDeclination('prawnik'), counter: 'nin', plGender: 'm', isAlive: true, isHuman: true, tags: ['professions'] },
        { jp: "kenchikushi", pl: caseDeclination('architekt'), counter: 'nin', plGender: 'm', isAlive: true, isHuman: true, tags: ['professions'] },
        { jp: "PAIROTTO", pl: caseDeclination('pilot'), counter: 'nin', plGender: 'm', isAlive: true, isHuman: true, tags: ['professions'] },
        { jp: "shouboushi", pl: caseDeclination('strażak'), counter: 'nin', plGender: 'm', isAlive: true, isHuman: true, tags: ['professions'] },
        { jp: "JAANARISUTO", pl: caseDeclination('dziennikarz'), counter: 'nin', plGender: 'm', isAlive: true, isHuman: true, tags: ['professions'] },
    ...
    items: [
        { jp: "tokei", pl: caseDeclination('zegar'), counter: '?', plGender: 'm', isAlive: false, isHuman: false, tags: ['items'] },
        { jp: "urushinuri", pl: caseDeclination('laka'), counter: '?', plGender: 'ż', isAlive: false, isHuman: false, tags: ['items'] },
        { jp: "jiki", pl: caseDeclination('porcelana'), counter: '?', plGender: 'ż', isAlive: false, isHuman: false, tags: ['items'] },
        { jp: "choukoku", pl: caseDeclination('figurka'), counter: '?', plGender: 'ż', isAlive: false, isHuman: false, tags: ['items'] },
        { jp: "omiyagehin", pl: caseDeclination('pamiątka'), counter: '?', plGender: 'ż', isAlive: false, isHuman: false, tags: ['items'] },
        { jp: "shokki", pl: caseDeclination('naczynie'), counter: '?', plGender: 'n', isAlive: false, isHuman: false, tags: ['items'] },
        { jp: "omocha", pl: caseDeclination('zabawka'), counter: '?', plGender: 'ż', isAlive: false, isHuman: false, tags: ['items'] },
        { jp: "fuutou", pl: caseDeclination('koperta'), counter: 'mai', plGender: 'ż', isAlive: false, isHuman: false, tags: ['items'] },
        { jp: "hagaki", pl: caseDeclination('pocztówka'), counter: 'mai', plGender: 'ż', isAlive: false, isHuman: false, tags: ['items'] },
        { jp: "ehagaki", pl: caseDeclination('widokówka'), counter: 'mai', plGender: 'ż', isAlive: false, isHuman: false, tags: ['items'] },
        { jp: "ningyou", pl: caseDeclination('lalka'), counter: '?', plGender: 'ż', isAlive: false, isHuman: false, tags: ['items'] },
        { jp: "touki", pl: caseDeclination('ceramika'), counter: '?', plGender: 'ż', isAlive: false, isHuman: false, tags: ['items'] },
        ...
        { jp: "mado", pl: caseDeclination('okno'), counter: '?', plGender: 'n', isAlive: false, isHuman: false, tags: ['items'] },
        { jp: "denwa", pl: caseDeclination('telefon'), counter: '?', plGender: 'm', isAlive: false, isHuman: false, tags: ['items'] },
        { jp: "ki", pl: caseDeclination('drzewo'), counter: '?', plGender: 'n', isAlive: false, isHuman: false, tags: ['items'] },
    ...
    notMaterial:[
        ...
        { jp: "byouki", pl: caseDeclination('choroba'), counter: '?', plGender: 'ż', isAlive: false, isHuman: false, tags: ['notMaterial'] },   
        { jp: "kekkon", pl: caseDeclination('ślub'), counter: '?', plGender: 'm', isAlive: false, isHuman: false, tags: ['notMaterial'] },   
        { jp: "kotoba", pl: caseDeclination('słowo'), counter: '?', plGender: 'n', isAlive: false, isHuman: false, tags: ['notMaterial'] },   
        { jp: "jugyou", pl: caseDeclination('zajęcia'), counter: '?', plGender: 'nmo', isAlive: false, isHuman: false, tags: ['notMaterial'] },   
        { jp: "imi", pl: caseDeclination('znaczenie'), counter: '?', plGender: 'n', isAlive: false, isHuman: false, tags: ['notMaterial'] },   
        { jp: "koe", pl: caseDeclination('głos'), counter: '?', plGender: 'm', isAlive: false, isHuman: false, tags: ['notMaterial'] },   
        { jp: "uta", pl: caseDeclination('piosenka'), counter: '?', plGender: 'ż', isAlive: false, isHuman: false, tags: ['notMaterial'] },   
        { jp: "sanpo", pl: caseDeclination('spacer'), counter: '?', plGender: 'm', isAlive: false, isHuman: false, tags: ['notMaterial'] },   
        { jp: "shukudai", pl: caseDeclination('zadanie domowe'), counter: '?', plGender: 'n', isAlive: false, isHuman: false, tags: ['notMaterial'] },   
