...
export const wordList = {
    animals: [
        ...
        // o! 
        { jp: 'neko', pl: caseDeclination(caseType['a u a em /cie /cie'], 'kot') },//[{M:'kot'},{D:'kota'},{C:'kotu'},{B:'kota'},{N:'kotem'},{Msc:'o kocie'},{W:'kocie'}]},
        { jp: 'sakana', pl: caseDeclination(caseType['y /ie /ę /ą /ie /o'], 'ryba') },//[{ M: 'ryba' }, { D: 'ryby' }, { C: 'rybie' }, { B: 'rybę' }, { N: 'rybą' }, { Msc: 'rybie' }, { W: 'rybo' }] },
        { jp: 'nezumi', pl: caseDeclination(caseType['y y x ą y o'], 'mysz') },//[{ M: 'mysz' }, { D: 'myszy' }, { C: 'myszy' }, { B: 'rybę' }, { N: 'rybą' }, { Msc: 'rybie' }, { W: 'rybo' }] },
        { jp: 'ka', pl: caseDeclination(caseType['a owi a em ze ze'], 'komar') },// ['komar', 'komara', 'komarowi', ''] },
        { jp: 'hato', pl: caseDeclination(caseType['(ą->ę) ia iowi ia iem iu iu'], 'gołąb') },//['gołąb', 'gołębia'] },
        { jp: 'suzume', pl: caseDeclination(caseType['(e->x) a owi a em u u'], 'wróbel') },// ['wróbel', 'wróbla'] },
        { jp: 'sou', pl: caseDeclination(caseType['(ń->n) ia iowi ia iem iu iu'], 'słoń') },//['słoń', 'słonia'] },
        { jp: 'tori', pl: caseDeclination(caseType['a owi a iem u u'], 'ptak') },//['ptak', 'ptaka'] },
        { jp: 'HAMUSUTAA', pl: caseDeclination(caseType['a owi a em u u'], 'chomik') },//['chomik', 'chomika'] },
        { jp: 'uma', pl: caseDeclination(caseType['(ń->n) ia iowi ia iem iu iu'], 'koń') },//['koń', 'konia'] },
        { jp: 'ushi', pl: caseDeclination(caseType['y /ie /ę /ą /ie /o'], 'krowa') },// ['krowa', 'krowy'] },
        { jp: 'niwatori', pl: caseDeclination(caseType['/y /ze /ę /ą /ze /o'], 'kura') },// ['kura', 'kury'] },
        { jp: 'ari', pl: caseDeclination(caseType['/i /ce /ę /ą /ce /o'], 'mrówka') },// ['mrówka', 'mrówki'] },
        { jp: 'shishiko', pl: caseDeclination(caseType['(e->x) a u a em ie ie'], 'lew') },// ['lew', 'lwa'] },
        { jp: 'inu', pl: caseDeclination(caseType['(i->x) a u a em ie ie'], 'pies') },
        { jp: 'saru', pl: caseDeclination(caseType['y /ie /ę /ą /ie /o'], 'małpa') },// ['małpa', 'małpy'] },
        { jp: 'usagi', pl: caseDeclination(caseType['a owi a iem u u'], 'królik') },// ['królik', 'królika'] },
        { jp: 'hitsuji', pl: caseDeclination(caseType['/y /y /ę /ą /y /o'], 'owca') },//['owca', 'owcy'] },
        { jp: 'buta', pl:caseDeclination(caseType['/ / /ę /ą / /o'], 'świnia') },// ['świnia', 'świni'] },
        { jp: 'jinchou', pl:caseDeclination(caseType['a owi a em ie ie'], 'pingwin') },//pl: ['pingwin', 'pingwina'] },
        { jp: 'ookami', pl: caseDeclination(caseType['a owi a iem u u'], 'wilk') },//['wilk', 'wilka'] },
        { jp: 'kuma', pl: caseDeclination(caseType['(ź->z) ia iowi ia iem iu iu'], 'niedźwiedź') },//['niedźwiedź', 'niedźwiedzia'] },
        { jp: 'risu', pl: caseDeclination(caseType['/i /ce /ę /ą /ce /o'], 'wiewiórka') },//['wiewiórka', 'wiewiórka'] },
        { jp: 'washi', pl: caseDeclination(caseType['()()((l)) a owi a em e e'],'orzeł')},// ['orzeł', 'orła'] },
        { jp: 'taka', pl:caseDeclination(caseType['(ą->ę) ia iowi ia iem iu iu'], 'jastrząb') },// ['jastrząb', 'jastrzębia'] },
        { jp: 'wani', pl: caseDeclination(caseType['a owi a em u u'], 'krokodyl') },//['krokodyl', 'krokodyla'] },
        { jp: 'shika', pl: caseDeclination(caseType['/y /ie /ę /ą /ie /o'], 'sarna') },// ['sarna', 'sarny'] },
        { jp: 'inoshishi', pl: caseDeclination(caseType['a owi a iem u u'], 'dzik') },//  ['dzik', 'dzika'] },
        { jp: 'hae', pl: caseDeclination(caseType['/y /sze /ę /ą /sze /o'], 'mucha') },// ['mucha', 'muchy'] },
        { jp: 'kitsune', pl:caseDeclination(caseType['a owi a em ie ie'], 'lis') },// pl: ['lis', 'lisa'] },
        { jp: 'harinezumi', pl: caseDeclination(caseType['a owi a em u u'], 'jeż') },// ['jeż', 'jeża'] },
        { jp: 'hiso', pl: caseDeclination(caseType['a owi a em u u'], 'nietoperz') },// ['nietoperz', 'nietoperza'] },
        { jp: 'tonbo', pl: caseDeclination(caseType['/i /ce /ę /ą /ce /o'], 'ważka') },// ['ważka', 'ważki'] },
        { jp: 'kame', pl:caseDeclination(caseType['ia iowi ia iem iu iu'], 'żółw') },//  ['żółw', 'żółwia'] },
        { jp: 'hakuchou', pl: caseDeclination(caseType['(ź->z) ia iowi ia iem iu iu'], 'łabędź') },// ['łabędź'] },
        { jp: 'kamo', pl:caseDeclination(caseType['/i /ce /ę /ą /ce /o'], 'kaczka') },// ['kaczka'] },
        { jp: 'fukurou', pl: caseDeclination(caseType['y /ie /ę /ą /ie /o'], 'sowa') },//['sowa'] },
    ],
    people: [
